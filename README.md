...
get the app created:
    ...
    $ heroku apps:create notes
    Creating notes... done, stack is cedar
    http://notes.herokuapp.com/ | git@heroku.com:notes.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://notes.herokuapp.com deployed to Heroku

    To git@heroku.com:notes.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://notes.herokuap.com
    ["Hello" :from Heroku]
